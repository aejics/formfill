...
<html>
    ...
    <body>
        ...
        <?php 
            if (isset($_COOKIE["loggedin"])) {
                ...
                <div class='h-100 d-flex align-items-center justify-content-center flex-column'>
                    ...
                    <button type='button' class='btn btn-secondary btn-lg btn-block' onclick='javascript:form1()' >
                    Declaração de Falta
        ...
        <script>
            function form1(){
                varPopup = window.open("fields.php?formid=1", "popup", "width=800,height=600,scrollbars=yes,resizable=yes");
            }
        </script>
